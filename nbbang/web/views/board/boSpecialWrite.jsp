...
<section>
	<div id="wrapper">
		...
		<hr color="black">
		<div id="editor">
			<form id="frm" action="<%=request.getContextPath()%>/board/boardSpcialWriteEnd" method="POST" enctype="multipart/form-data">
				...
				<div id="submitBtn">
					<button class="marginTop btn btn-outline-secondary" type="button" onclick="fn_submit();">등록</button>
				</div>
			</form>
		</div>
	</div>
