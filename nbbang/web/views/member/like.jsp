    ...
    <div id="myPageWrapper">
        ...
        <div id="iCreateContainer">
            <div class="item textField" id="containerTitle">
                <div id="modifyProfile" style="font-size: 24px; padding: 5px; padding-bottom: 0; text-align: left;" >좋아요 한 게시글</div>
                <div style="font-size: 16px; padding-left: 10px; text-align: left;" >좋아요를 누른 게시글 목록입니다. 이미 시작된 거래는 보이지 않습니다.</div>
