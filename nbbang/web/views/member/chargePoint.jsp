    ...
    $('#charge_kakao').click(function () {
        ...
        IMP.request_pay({
            ...
            if (rsp.success) {
                ...
                $.ajax({
                    type: "GET", 
                    url: "/member/chargePointCpl", //충전 금액값을 보낼 url 설정
                    data: {
                        "amount" : money
                    },
                });
            ...
            alert(msg);
            document.location.href="<%=request.getContextPath()%>/member/myPage?usid=<%=loginnedMember.getUsid()%>"; //alert창 확인 후 이동할 url 설정
        });
    });
</script>
</body>
