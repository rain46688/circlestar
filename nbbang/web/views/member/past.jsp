    ...
    <div id="myPageWrapper">
        <div id="myPageSideBar">
            ...
            <div id="sideBarLinkContainer">
                ...
                <div>
                    <a class="nav-link postList active" href="<%=request.getContextPath()%>/member/pastList?usid=<%=loginnedMember.getUsid()%>">과거 거래 내역</a>
                </div>
        ...
        <div id="iCreateContainer">
            <div class="item textField" id="containerTitle">
                <div id="modifyProfile" style="font-size: 24px; padding: 5px; padding-bottom: 0; text-align: left;" >과거 거래 내역</div>
                <div style="font-size: 16px; padding-left: 10px; text-align: left;" >거래 완료된 게시물 목록입니다.</div>
