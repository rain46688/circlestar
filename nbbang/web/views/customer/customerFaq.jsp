    ...
    <div class="container">
        <ul class="accordion">
         <li class="item">
             <h2 class="accordionTitle">Nbbang 운영정책 <span class="accIcon"></span></h2>
                <div class="text">우리 엔빵의 따뜻한 거래를 위해 다음과 같은 약속을 꼭꼭 지켜주세요. <br>
            ...
            <li class="item">
               ...
               <div class="text">엔빵은 믿을 수 있어요! <br><br>
                 1:1 엔빵채팅으로 대화해요<br>
                   
                   엔빵 내의 채팅을 통해 거래하는게 가장 안전해요. 당근채팅에서는 안전한 거래를 위해 대화 내용에 따라 다양한 안내 및 경고 메시지들을 보내고 있어요. 교묘해지고 있는 사기 케이스들을 모니터링하고, 이를 막기 위한 시스템을 고도화하고 있어요. 일부 사용자들을 실시간으로 제재하여 거래가 진행되지 않도록 채팅을 막기도 해요. 1년 365일 24시간 안전하게 지켜지는 당근 채팅으로 믿고 거래하세요!
                   <br><br>
                   
                   
                    당신 근처에서 만나요<br><br>
                   
                   중고거래 사기의 대부분은 택배거래에서 발생한다는 사실, 알고 계셨나요? 근처 이웃들과 사고 파는 엔빵에서는 직거래를 권장하고 있어요. 직거래할 때는 누구나 찾기 쉽고 안전한 공공장소가 좋아요. 이웃과 따뜻하게 거래하세요.
                   <br>
                   ...
                   당근마켓은 다양한 사기 사례들을 분석하고 있어요. 비슷한 수법의 범죄가 재발하지 않도록 모니터링하여 실시간으로 제재하고 있어요. 제재 당한 사용자는 서비스를 사용할 수 없어요. 사기를 저지른 사용자가 계정을 바꾸며 재가입해도 서비스를 사용할 수 없어요.
                   <br><br>
                   
                   
                    채팅 메시지로 미리 알려줘요<br>
                   대화 내용에 따라 다양한 안내 및 경고 메시지들을 보내고 있어요. 사기 이력이 있는 사용자와 대화를 하면 사기 이력이 있다고 알려주고, 메신저나 문자 등으로 대화를 유도하면 주의할 수 있게 안내 메시지를 보내요. 새롭게 등장한 사기 사례들도 채팅방에서 미리 알려주고 사용자가 피할 수 있게 돕고 있어요. 이 외에도 정말 많은 시스템 메시지가 있어요. 안전한 거래를 만들기 위해 오늘도 개선하고 있답니다.
                   <br><br>
                   
                    게시글을 분석해요<br>
                   머신러닝 기술을 이용해 게시글을 분석하고 있어요. 사기꾼의 게시글을 포함 판매금지품목이나 전문판매업자들의 판매글, 광고글, 중복게시글 등은 노출되지 않아요. 신뢰할 수 있는 개인들의 마켓을 만들기 위해 노력하고 있어요.
                </li>
            <li class="item">
                <h2 class="accordionTitle">지역광고비는 얼마인가요?<span class="accIcon"></span></h2>
            <div class="text">지역광고 비용은 선택한 동네의 방문자 수와 기간에 따라 달라져요. <br><br>
        ...
        <div class="contaniner2-kdh">
            ...
            <div class="main-content-kdh">
                <p class="content1">그래도 해결이 안되시나요?</p>
                <a href="" class="content2">1:1 고객센터 문의하기</a>
            </div>
        </div>
</div>
...
ul.sidebarTitle li#kdh-side-Title{
	font-size: 27px;
	font-weight: bold;
	padding-top: 1em;
}
ul.sidebarTitle li#kdh-side-text span{
	font-weight: bold;
	font-size: 20px;
	padding-top: 20em;
}
...
div#kdh-sidebar-left{
	border: 1px solid darkgray;
}
 div#kdh-sidebar-left ul li{
 	list-style:none;
    padding: 3%;
 }
